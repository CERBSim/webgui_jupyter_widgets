...
# -*- coding: utf-8 -*-
#
# webgui_jupyter_widgets documentation build configuration file
#
...
project = 'webgui_jupyter_widgets'
copyright = '2021, CERBSim'
author = 'CERBSim'
...
_version_py = os.path.join(repo, 'webgui_jupyter_widgets', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'webgui_jupyter_widgetsdoc'
...
latex_documents = [
    (master_doc, 'webgui_jupyter_widgets.tex', 'webgui_jupyter_widgets Documentation',
     'CERBSim', 'manual'),
]
...
man_pages = [
    ...
    'webgui_jupyter_widgets Documentation',
     [author], 1)
]
